...
public interface CourseService {
	...
	List<SerchTeacherResult> showChooseCourse(SerchTeacher teacher);/* 根据学生学院查找指定课程 */
	/*
	 * void chooseCourseStudentNumber(Course course);根据课程id更新课程选课人数 void
	 * addChooseCourse(ChooseCourse chooseCourse);向选课信息表中插入记录 Integer
	 * studentChooseMaxCourse(String studentNname);查询每名学生选了几门课
	 * List<TeacherSeeCourseList> chooseCourseList(String teacherName);查询选择该老师的课程信息
	 * List<adminSeeStudentChooseCourseMsg>
	 * adminSeeStudentChooseCourseMsg();管理员查看学生选课信息 List<Course>
	 * showAllCourseMsg();查看所有课程信息
	 */
